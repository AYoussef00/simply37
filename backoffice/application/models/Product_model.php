...
class product_model extends inf_model {
    ...
    public function addProduct($pck_type, $prod_name, $product_amount, $pair_value, $bv_value, $type_of_package, $package_validity,$package_id, $referral_commission = 0, $pair_price = 0, $roi= 0, $days = 0, $img_name = '',$description = '',$category_id = '',$simply_url='yes',$package_combo,$board_system='no',$service_system='no',$service_type,$learning_system,$forex_system,$tourism_system='no') {
    ...
    public function updateProduct($pck_type, $id, $prod_name, $product_amount, $pair_value, $bv_value, $type_of_package, $package_validity,$package_id, $img_name = '', $description = '', $category_id = '',$simply_url='',$package_combo,$board_system='no',$service_system='no',$service_type ,$learning_system,$forex_system,$tourism_system='no') {

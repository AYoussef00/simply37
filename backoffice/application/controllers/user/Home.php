...
class Home extends Inf_Controller
{
	...
	$board_status='yes';
        ...
        $check_package_support_learning=$this->validation_model->getPackageSupport($this->LOG_USER_ID,'learning');
        $this->set('check_package_support_learning',$check_package_support_learning);
        
        $check_package_support_forex=$this->validation_model->getPackageSupport($this->LOG_USER_ID,'forex');
        $this->set('check_package_support_forex',$check_package_support_forex);

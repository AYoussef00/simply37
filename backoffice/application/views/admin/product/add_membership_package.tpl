            ...
            <legend><span class="fieldset-legend" id="title">{lang('add_membership_package')}</span>
              ...
              {include file="layout/error_box.tpl"}
                ...
                <div class="form-group">
                    ...
                    <option value="normal_pack">{lang('normal_pack')}</option>
                    <option value="founder_pack">{lang('founder_pack')}</option>
                ...
                <div class="form-group">
                    ...
                    <option selected value="no">{lang('No')}</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control package-options" name="service_type" id="service_type" style="display: none;">
    <option selected>Select Service Type</option>
    <option value="s150">s150</option>
    <option value="s350">s350</option>
    <option value="s750">s750</option>
    <option value="s1500">s1500</option>
</select>

<script>
        $('#service_system').change(function() {
        if ($(this).val() === 'yes') {
            $('#service_type').show();
        } else {
            $('#service_type').hide();
                ...
                <div class="form-group">
                    ...
                    <label class="control-label required" for="learning_system">{lang('Support Learning system')}</label>
                    
                    <select class="form-control" name="learning_system" id="learning_system">
                    ...
                    <span name ='form_err'>{form_error('learning_system')}</span>
                ...
                <div class="form-group">
                    ...
                    <label class="control-label required" for="forex_system">{lang('Support Forex System')}</label>
                    
                    <select class="form-control" name="forex_system" id="forex_system">
                    ...
                    <span name ='form_err'>{form_error('forex_system')}</span>
                ...
                <!-- <div class="form-group">
                    ...
                    {foreach from=$combo_packs item=v}
